...
import { searchWBFeedbacks } from './controllers/wb/feedback-search/search-feedbacks';
  ...
  return express()
    ...
    .use('/api', express.Router()
      ...
      .use('/common', express.Router()
        ...
        .use('/meta', express.Router()
          .get('/', (req: express.Request, res: express.Response) => res.send({ l: context.launchTime }))
          .get('/mongo-setup', (req, res) => res.send({ l: context.mongoDB.setupStatus }))
        )
      )
    )
